...
const DefaultNav = () => {
  ...
  return (
    <div className="bg-graybrand pt-8">
      <nav className="flex-between max-w-6xl px-4 lg:p-0 m-auto items-baseline w-full text-base mt-0 sticky top-0 py-[10px] font-light">
        <Link href="/">
