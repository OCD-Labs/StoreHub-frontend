...
const Products = () => {
  ...
  const renderedItem = data.map((item, id) => {
    return (
        <div key={id} className="border w-[80%] md:w-[25%] mr-4 md:mr-6 flex-shrink-0 flex-grow-0">
    ...
    <div>
      ...
      <section className="md:flex items-center justify-between">
        ...
        <div className="flex flex-col gap-3 md:w-[45%] md:h-[25rem]">
          <p className="font-semibold text-[17px] text-black">{productName}</p>
          <span className="flex text-[17px] items-center justify-start">
            <img
              className="w-[27px]"
              src="../../assets/icons/near.svg"
          ...
          <div className="flex justify-between my-2 md:my-0">
            <button className="rounded-[10px] px-2 text-white bg-[#161616] text-lg w-[40%]">
              Add to Cart
            </button>
      ...
      <section>
        <p className="font-semibold text-[17px] text-black md:hidden">Product Info</p>
        <p className="md:hidden py-2">See product review and product description</p>
